using EmployeesManagement.Models; // for Employee class
...
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser> // ✅ must inherit IdentityDbContext
    {
        ...
        public DbSet<FixedAsset> FixedAssets { get; set; } // your Employee table

        public DbSet<Client> Clients { get; set; } // your Employee table
        public DbSet<Employee> Employees { get; set; } // your Employee table
